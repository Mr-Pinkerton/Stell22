...
| PSR-P2 SHADOW activation control | Candidate `audit/08.25`. **IMPLEMENTED / CI VERIFIED / AWAITING HEAD REVIEW / NOT MERGED / NOT RUN IN PRODUCTION / SHADOW INACTIVE**. Previous candidate `357576f` is **REWORKED / SUPERSEDED**. Corrective commit `5f48022`. `PRODUCTION_ENVIRONMENT_REF_POLICY = UNSAFE`. Not production activation. Dual-write **NOT STARTED**. PSR-P3 **NOT STARTED**. |

Always verify current `main` HEAD before relying on git SHA. Production **application** checkpoint = `2d2cbcbdc01ee83cb9103ad8fdaa43ebf8488dcf` (Production Deploy `35616829882`). Current GitHub `main` before this docs closeout `49aa1209` is the PR #46 verifier-workflow merge and is **not** a production application SHA. Historical production checkpoints include `b033cfad` (run `35536089109`, Package 2), `4508ee1` (run `35524416936`, Package 1), `69e0f53` (run `35510094974`, raw SHADOW writers), `0cc8382` (run `35502770382`, raw identity prerequisite), `eb02b17` (run `35337215903`), `27538a5` (run `35329071777`), `c14a586` (run `35314440036`), `de2e1c0` (run `35257469956`), `92532e8` (run `35228794988`), `0686d00`, `71a01b4`. Historical merge/docs SHAs `3f89fff` (PR #9) / `394f753` / `bd82aa0` / `b11c37d` / `2f8ec8d` are not rewritten.
...
| `audit/08.25-psr-p2-shadow-activation-control.md` | PSR-P2 SHADOW activation control and start verification | Control-plane rework | Starting main `693a9f12`; previous candidate `357576f` **REWORKED / SUPERSEDED**; corrective `5f48022` | `IMPLEMENTED / CI VERIFIED / AWAITING HEAD REVIEW / NOT MERGED / NOT RUN IN PRODUCTION / SHADOW INACTIVE` | NO until HEAD accepts | Canonical-main dispatch guard. Post-control allows SHADOW growth without row loss. `PRODUCTION_ENVIRONMENT_REF_POLICY = UNSAFE`. No schema. No production mutation. |
...
- Previous candidate `357576f182cf71331cf1547b20a09fbe451bbb12` is **REWORKED / SUPERSEDED / NOT ACCEPTED**. Its CI `35630639761` remains historical evidence only.
- Corrective commit: `5f480224d28f4df484d20a81e286ff014a2ed147`
- Corrective tree: `92a9e073d44e7b3dd16db50aa7671b0c7041c983`
- Rework implementation PR merge-ref CI: `35632266307` SUCCESS. Evidence class = **PR MERGE-REF CI / EXACT CANDIDATE-TREE VERIFIED**, not `exact-head CI`. Merge-ref `63acbe5c9d8b2052d944bff52a96283cc466d38c`; parents `693a9f12` + `5f48022`; tested tree `92a9e073` equals that commit's tree.
...
- Implementation PR merge-ref CI: `35629950903` SUCCESS. Evidence class = **PR MERGE-REF CI / EXACT CANDIDATE-TREE VERIFIED**, not `exact-head CI`. Merge-ref `29516a73`; parents `693a9f12` + `ad4ad12`; tested tree `05971b50` equals that commit's tree.
- Canonical?: **NO** until HEAD accepts and the candidate is merged

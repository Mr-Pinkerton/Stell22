...
| `audit/08.08-psr-p2-r04-supply-cycle-identity.md` | PSR-P2 R-04 Supply cycle identity | Contract + implementation | App `de2e1c0`; base `de2e1c0` | `ARCHITECTURE CLOSED / IMPLEMENTATION VERIFIED / NOT DEPLOYED` | NO (feature branch until merge) | Long-lived Supply + generation/open. One-shot shortfall unchanged. Ozon cancel closes Δ=0 cycles. WB consume-only; DI-011 still deferred. No InventoryMovement writer. Dual-write **NOT STARTED**. |

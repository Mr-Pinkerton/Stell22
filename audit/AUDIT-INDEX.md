...
| PSR-P2 SHADOW activation control | Candidate `audit/08.25`. **IMPLEMENTED / CI VERIFIED / AWAITING HEAD REVIEW / NOT MERGED / NOT RUN IN PRODUCTION / SHADOW INACTIVE**. Not production activation. Dual-write **NOT STARTED**. PSR-P3 **NOT STARTED**. |
...
| `audit/08.25-psr-p2-shadow-activation-control.md` | PSR-P2 SHADOW activation control and start verification | Control-plane candidate | Starting main `693a9f12`; production application `2d2cbcbd` | `IMPLEMENTED / CI VERIFIED / AWAITING HEAD REVIEW / NOT MERGED / NOT RUN IN PRODUCTION / SHADOW INACTIVE` | NO until HEAD accepts | Does not activate SHADOW. Gate activation is not dual-write start. Package 3 dormant verifier unchanged. No schema. No production mutation. |

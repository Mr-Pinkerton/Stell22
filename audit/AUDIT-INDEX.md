...
- NEXT: **PSR-P2 INVENTORY SHADOW WRITER IMPLEMENTATION PACKAGE** (historical closeout next; implementation is `audit/08.14` on the feature branch).

### 08.14 — PSR-P2 Inventory SHADOW writer

- File: `audit/08.14-psr-p2-inventory-shadow-writer.md`
- Scope: first physical InventoryMovement writer for Inventory `conductInventory`; `InventoryPhysicalEffect[]` mapping; gate-first TX; P2-02/P2-03/P2-05; writer PostgreSQL proofs.

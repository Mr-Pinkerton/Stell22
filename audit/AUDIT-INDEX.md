...
| `audit/08.19-psr-p2-raw-identity-prerequisite.md` | PSR-P2 raw receipt / write-off identity | Implementation + deploy closeout | PR #33 merge `76131ca`; accepted head `919a427`; historical identity deploy `35502770382` / `0cc8382`; historical raw-writer deploy `35510094974` / `69e0f53`; current prod `2d2cbcbd` / `35616829882` | `IMPLEMENTED / MERGED / DEPLOYED / POST-DEPLOY VERIFIED` | YES after this closeout merge | Historical implementation **NOT DEPLOYED** preserved. Identity deploy `35502770382` first made tables live. Current production is later application SHA `2d2cbcbd`. Migration APPLIED; tables LIVE / EMPTY AT CUTOVER; historical backfill NO. Connected writers **DEPLOYED DORMANT**. Dual-write **NOT STARTED**. Later writers: `08.20`. |
| `audit/08.20-psr-p2-raw-shadow-writers.md` | PSR-P2 raw receipt / write-off SHADOW writers | Implementation + deploy closeout | PR #36 merge `0bf2c77`; accepted head `424f119`; historical package deploy `35510094974` / `69e0f53`; current prod `2d2cbcbd` / `35616829882` | `IMPLEMENTED / MERGED TO MAIN / CI VERIFIED / DEPLOYED / POST-DEPLOY VERIFIED / SHADOW INACTIVE` | YES | Historical package contours **9**. Current source/`main` / production dormant contours **12 / 12**. Package deploy / no new migration. No activation. P2 **NOT COMPLETE**. P3 **NOT STARTED**. Later discovery: `08.21`. |
...
- Scope: fail-closed D/E physical delete; preserve F; G remainingQuantity === 0 + existing guards inside TX; H INACTIVE qty===0 / ACTIVE any-row.
...
- Scope: A/B/C retained quantity-edit identity / replay / CAS / actor / effect snapshot. No InventoryMovement writer.
- Status: **IMPLEMENTED / MERGED TO MAIN / CI VERIFIED / DEPLOYED / POST-DEPLOY VERIFIED**
- Starting `origin/main`: `fb22ab7ce2e55cf9ee4aee8026298f488107698c`
- Accepted HEAD: `e143e22b6f805c9d4d053d761b5629fa5a325d9b`
- PR #42 merge: `b033cfad88f01d9231f7b892fcce290244f48130`
...
- Read-only verifier: `35592291536` **PASS**
- `ProductionOperationQuantityEdit`: **LIVE / EMPTY**
- InventoryMovement: **0**
- SHADOW: **ABSENT**
- InventoryMovement writer added: **NO**
- Dual-write: **NOT STARTED**
...
- Final PR merge-ref CI: `35612492381` SUCCESS (`fca79157`; parents `4c662f96` + `7f090e13`; tested tree `3e8fde49`)
...
- Verifier PR #46 merge: `49aa1209e7815d8545b6c45f42ca0770a26a767b` (**not** a production application SHA)
- Post-verifier-merge CI: `35619130027` SUCCESS
- Read-only production verifier: `35619733266` SUCCESS
- SHADOW: **ABSENT**
- `production_cost_flow`: **ABSENT**
- InventoryMovement: **0**
- `P2_ROW_COUNT`: **0** (observational)
...
- Candidate PR CI: `35637791430` SUCCESS. Evidence class = **PR MERGE-REF CI / EXACT CANDIDATE-TREE VERIFIED**, not `exact-head CI`. Merge-ref `3ba02c69d39bdc3cdd161bd0523e76fce7c57572`; parents `693a9f12` + `7e58c3df`; tested tree `b5c8e5a1`.
- Implementation merge: `231026601cdbaa0ff1a8a80411f90a33b92eaef8`. Parents `693a9f12` + `7e58c3df`. Merged tree `b5c8e5a1`.
- Post-merge CI: `35638837175` SUCCESS. Event `push`. SHA `231026601cdbaa0ff1a8a80411f90a33b92eaef8`.
- Earlier candidates `357576f` and `329c2be` are **REWORKED / SUPERSEDED / NOT ACCEPTED**. Their CI records stay historical. Opus reviewed `329c2be` (P0=0 / P1=1 / P2=2) and did not review `7e58c3df` directly.
- Historical pre-hardening read, preserved: `PRODUCTION_ENVIRONMENT_REF_POLICY = UNSAFE` (`deployment_branch_policy: null`; deployment-branch-policies HTTP 404). That read was the activation blocker at the 08.25 closeout. Environment settings were not changed by `08.25`. Current policy: `audit/08.26`.
- First implementation commit: `ad4ad12cebc7b26e07c588b0fb5d1655799f2a17`
- PR: [#48](https://github.com/Mr-Pinkerton/Stell22/pull/48) **MERGED**
- Starting `origin/main`: `693a9f12fe52b7b6babecdf4f8b6d05e1082f7b6`
- Production application pin: `2d2cbcbdc01ee83cb9103ad8fdaa43ebf8488dcf`
- Schema / migration: **NO / NO**
- Production accessed / mutated: **NO / NO**
- SHADOW activated: **NO**
- `production_cost_flow`: unchanged
- Dual-write: **NOT STARTED**
- PSR-P3: **NOT STARTED**
- `ARCH-P1-001`: **OPEN / CONFIRMED**
- `INC-001`: **OPEN — CONTAINMENT DEPLOYED; PHYSICAL FACT REQUIRED FOR DATA CORRECTION**
- Package 3 dormant verifier: unchanged
- Do not dispatch the new workflows from this index entry.
- Historical NEXT at the 08.25 closeout, superseded by `audit/08.26`: **PRODUCTION ENVIRONMENT REF-POLICY HARDENING**. Not an environment change inside the 08.25 closeout, not SHADOW activation, and not a deploy. PSR-P2 remains **NOT COMPLETE**. PSR-P3 remains **NOT STARTED**.

### 08.26 — PSR-P2 Production Environment ref-policy hardening

- File: `audit/08.26-psr-p2-production-environment-ref-policy-hardening.md`
- Status: **COMPLETE / HEAD ACCEPTED / INDEPENDENT REVIEWED / LIVE VERIFIED / CONFIGURATION APPLIED / NO PRODUCTION ACCESS / NO DEPLOY / SHADOW INACTIVE**
- Canonical?: **YES** after this docs closeout is accepted and merged
- This was GitHub Environment configuration, not an application deployment
- Starting `origin/main`: `1c8b45b29acb1de1bac6eae13572dab71305de3e`
- Starting tree: `102692287c6e0dfd575590fc94cdd4e5a0f582dc`
- Production application: `2d2cbcbdc01ee83cb9103ad8fdaa43ebf8488dcf` (unchanged; Production Deploy `35616829882`)
- Last Actions run at closeout start: `35642902576` SUCCESS (CI / `push` / `main`)
- Environment id: `21178616940`
- `can_admins_bypass`: `false`
- `protected_branches`: `false`
- `custom_branch_policies`: `true`
- Branch policy: id `60621333`, name `main`, type `branch`. Exactly one. No tag policy. No wildcard policy.
- Protection rule: id `66278516`, type `branch_policy`
- Required reviewers / wait timer / custom deployment protection app: none
...
- P2-1: `CLOSED BY THIS DOCS CLOSEOUT`
- P2-2: `ACCEPTED NON-BLOCKING HARDENING BACKLOG`. Branch protection not implemented here.
- P2-3: `ACCEPTED NON-BLOCKING SUPPLY-CHAIN HARDENING BACKLOG`. `appleboy/ssh-action@v1.2.4` is used only by `deploy-production.yml`, `package2-production-readonly-verify.yml`, and `supply-production-preflight.yml`. The SHADOW workflows use `scripts/shadow-activation-ssh.sh`. Actions not pinned here.
- P2-4: `ACCEPTED / CURRENT DOCS DISTINGUISH DEPLOYMENT RECORD FROM PRODUCTION APPLICATION`
- P2-5: `ACCEPTED INHERENT ADMIN CONTROL / MONITOR BY LIVE POLICY RE-READ`
- SHADOW: **INACTIVE**
- Dual-write: **NOT STARTED**. SHADOW gate ACTIVE alone is not dual-write started.

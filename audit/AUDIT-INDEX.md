...
| Application-code checkpoint | `de2e1c015423e7b848f0583c0e75b2abb12733d9` — Production Deploy `35257469956` SUCCESS (PSR-P2 general preconditions: Q4/R-07/R-10/R-11 **DEPLOYED DORMANT**). Prior prod SHA `92532e8` (deploy `35228794988`, PSR-P1 empty SHADOW) is **historical**. Containment SHA `3608b36` remains in the running tree. |
| Docs on `main` | AUDIT 1 artifact `08.01` (`COMPLETE / REVIEWED`). ARCH-2 artifact `08.02` (`ACCEPTED / REVIEWED`). PSR-P0-CORR artifact `08.03` (`ACCEPTED DESIGN / NOT IMPLEMENTED`). PSR-P0-CORE artifact `08.04` (`ACCEPTED DESIGN / NOT IMPLEMENTED`). PSR-P1 schema contract `08.05` (**ACCEPTED DESIGN**; historical **NOT IMPLEMENTED** at contract creation preserved). PSR-P1 closeout `08.06` (`COMPLETE / IMPLEMENTED / DEPLOYED / SHADOW SCHEMA EMPTY`). PSR-P2 general preconditions `08.07` (`ARCHITECTURE CLOSED / IMPLEMENTATION VERIFIED / MERGED TO main / NOT DEPLOYED`; Canonical? **YES** after PR #9). PR #9 implementation merge checkpoint = `3f89fffb8dc5842027420095bd3c85a07a85e284`; current `main` HEAD must be verified before work because later docs-only merges may advance it. |
...
| PSR-P2 general preconditions | `PSR-Q-004` / R-07 / R-10 / R-11 = **ARCHITECTURE CLOSED / IMPLEMENTATION VERIFIED / MERGED TO main / NOT DEPLOYED** (`audit/08.07`, Canonical? **YES**; PR #9 **MERGED**, merge `3f89fff`, post-merge CI `35250490823` SUCCESS). Subsequently **DEPLOYED** at application `de2e1c0` (Production Deploy `35257469956`). R-04 = **ARCHITECTURE CLOSED / IMPLEMENTATION VERIFIED / NOT DEPLOYED** (`audit/08.08`; Canonical? **YES when present on main; PR #11 is the delivery vehicle**). **NEXT = R-04 DELIVERY — PR #11 MERGE / PRODUCTION PREFLIGHT / DEPLOYMENT DECISION**. Dual-write **NOT STARTED**. R-05 / R-06 remain OPEN. |
...
Always verify current `main` HEAD before relying on git SHA. PR #9 implementation merge checkpoint = `3f89fffb8dc5842027420095bd3c85a07a85e284`. Production **application** SHA remains `92532e8` after Production Deploy `35228794988` — intentionally behind GitHub `main` until a separately authorized deploy. Historical SHA `394f753` (pre-PR-#9 `main`) / `0686d00` / `71a01b4` / docs-merge SHAs `bd82aa0` (08.03) / `b11c37d` (08.04) / `2f8ec8d` (08.05) are not rewritten.
...
| `audit/08.08-psr-p2-r04-supply-cycle-identity.md` | PSR-P2 R-04 Supply cycle identity | Contract + implementation | App `de2e1c0`; base `de2e1c0` | `ARCHITECTURE CLOSED / IMPLEMENTATION VERIFIED / NOT DEPLOYED` | YES when present on main; PR #11 is the delivery vehicle | Long-lived Supply + generation/open. One-shot shortfall unchanged. Ozon cancel closes Δ=0 cycles. WB consume-only; DI-011 still deferred. No InventoryMovement writer. Dual-write **NOT STARTED**. Same-sync cancel wins; cross-sync stale SHIPPED is eventual consistency, not a cycle-identity failure. |
...
`08.07` is **PSR-P2 general pre-dual-write preconditions**, now canonical on GitHub `main` after PR #9 (Canonical? **YES**). Architecture for `PSR-Q-004` / R-07 / R-10 / R-11 = **CLOSED**. Implementation **VERIFIED / MERGED TO main / NOT DEPLOYED**. Merge commit `3f89fffb8dc5842027420095bd3c85a07a85e284`. Post-merge CI **SUCCESS** `35250490823`. Dual-write **NOT STARTED**. The earlier feature-branch / PR-open status is **historical**.
...
`PSR-Q-004` = **ARCHITECTURE CLOSED / IMPLEMENTATION VERIFIED / MERGED TO main / NOT DEPLOYED** (`audit/08.07`, Canonical? **YES**). `PSR-Q-003` / `Q6` remain later-timing (`Q3` before physical recon / P4; `Q6` before FINAL epoch / P6).
...
`PSR-Q-004` / R-07 / R-10 / R-11 = **ARCHITECTURE CLOSED / IMPLEMENTATION VERIFIED / MERGED TO main / NOT DEPLOYED** (`audit/08.07`, Canonical? **YES**; subsequently deployed at `de2e1c0`). R-04 = **ARCHITECTURE CLOSED / IMPLEMENTATION VERIFIED / NOT DEPLOYED** (`audit/08.08`; Canonical? **YES when present on main; PR #11 is the delivery vehicle**). **NEXT = R-04 DELIVERY — PR #11 MERGE / PRODUCTION PREFLIGHT / DEPLOYMENT DECISION**. PSR-P2 dual-write **NOT STARTED**. R-05 / R-06 remain OPEN before their contour dual-write. Not dual-write, not OPENING_BALANCE data, not AUTHORITATIVE rows, not projection change, not Correction Center.

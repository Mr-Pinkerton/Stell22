...
| PSR-P2 SHADOW activation control | Candidate `audit/08.25`. **REWORK IN PROGRESS / AWAITING CI / NOT ACCEPTED / NOT MERGED / NOT RUN IN PRODUCTION / SHADOW INACTIVE**. Previous candidate `357576f` is **REWORKED / SUPERSEDED**. `PRODUCTION_ENVIRONMENT_REF_POLICY = UNSAFE`. Not production activation. Dual-write **NOT STARTED**. PSR-P3 **NOT STARTED**. |
...
| `audit/08.25-psr-p2-shadow-activation-control.md` | PSR-P2 SHADOW activation control and start verification | Control-plane rework | Starting main `693a9f12`; previous candidate `357576f` **REWORKED / SUPERSEDED** | `REWORK IN PROGRESS / AWAITING CI / NOT ACCEPTED / NOT MERGED / NOT RUN IN PRODUCTION / SHADOW INACTIVE` | NO until HEAD accepts | Canonical-main dispatch guard. Post-control allows SHADOW growth without row loss. `PRODUCTION_ENVIRONMENT_REF_POLICY = UNSAFE`. No schema. No production mutation. |

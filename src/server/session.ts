 ...
 *
 * Server Actions обязаны вызывать этот гейт сами: layout/proxy не являются
 * авторизацией action POST. User в текущей архитектуре всегда ADMIN; работник
 * терминала — отдельная Employee-сессия, не роль User.
 */

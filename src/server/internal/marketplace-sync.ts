...
import type { Marketplace } from "@/mocks/warehouse-fixtures";
import {
  mapOzonPosting,
  mapOzonStock,
  mapOzonSupplyOrder,
...
function noteSideError(
  side: MpSyncSideReport,
  label: string,
  err: unknown,
  warnings: string[],
): void {
...
async function fetchMarketplaceData(
  ...
  const creds = await loadStoredApiCredentialsInternal();

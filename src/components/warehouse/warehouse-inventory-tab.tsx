        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground max-w-xl text-xs leading-relaxed">
              Включит в черновик все активные изделия, пулы заготовок (без присадки),
              готовые детали с присадкой и крепёж/упаковку — даже с нулевым остатком.
              Впишите фактические количества и проведите, чтобы задать стартовые
              остатки. Сырьё (рейки) вводится отдельно через раздел «Закупки».
            </p>
          </div>
        </div>
      )}
